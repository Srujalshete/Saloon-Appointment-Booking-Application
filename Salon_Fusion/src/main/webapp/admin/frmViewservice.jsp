...
<div class="container px-lg-5 frm" style="margin-top:50px">
  <div class="row mx-lg-n4" >
    ...
    <div class="col py-3 px-lg-4 border bg-light">
     <form action=showtreker.jsp method=get >
      <h2 class="text-center bg-warning" style="background-color:;width:100%;padding:15px;text-align:center;color:white">View Services </h2>
  ...
  <tbody>
    ...
    <td><%=rs.getString(3)%></td>
         ...
         <td><a href="frmupdateservice.jsp?pid=<%=rs.getString(1)%>" class="btn btn-danger">Update</a></td>
