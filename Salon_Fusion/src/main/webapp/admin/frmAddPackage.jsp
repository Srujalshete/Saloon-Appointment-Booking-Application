	...
	<div class="container px-lg-5 frm" style="margin-top: 50px">
		<div class="row mx-lg-n5 d-flex justify-content-center" style="margin-left: 200px">
			...
			<div class="col-5 py-3 px-lg-5 border bg-dark ">
				<form action=packdata.jsp method=get id=frmAddEvent>
					...
					<div class=row>
						<div class=col>
							<div class="mb-3">
								<label for="usename" class="form-label">Package Name</label> <input
					...
					<div class=row>
							...
							<div class=col>
							<div class="mb-3">
								<label for="password" class="form-label">Package Picture</label> 
					...
					<div class=row>
						<div class=col>
							<div class="mb-3">
								<label for="password" class="form-label">Package Rate</label> <input
					...
					<div class="mb-3">
						<label for="password" class="form-label">Package_Details / Description</label>
					...
					<div class="mb-3" style="margin-left: 80px">
						<input type="submit" value="Add Package" onclick="addEventData()"
