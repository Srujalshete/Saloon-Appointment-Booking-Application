...
PreparedStatement ps=con.prepareStatement("select * from services where sid=?");
ps.setInt(1,pid);    	
ResultSet rs=ps.executeQuery();
      ...
      <div class="row">
        ...
        <form action=updateservicedata.jsp method="get" >
     <div class=info><h2 class="text-center" style="color:#4682B4;">Update Services </h2></div>
